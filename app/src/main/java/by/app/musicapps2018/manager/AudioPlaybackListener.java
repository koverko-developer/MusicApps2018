...
public class AudioPlaybackListener implements PlaybackListener, AudioManager.OnAudioFocusChangeListener,
    ...
    public void setPlayer(JcPlayerView playerView){
        this.jcPlayerView = playerView;
    }
        ...
        try {
            ...
            if (mState == PlaybackStateCompat.STATE_PAUSED && !mediaHasChanged && mMediaPlayer != null) {
                ...
                if(item.getMediaUrl()!= null && !item.getMediaUrl().isEmpty()){
                    ...
                    item.setMediaUrl(source);
                    mMediaPlayer.prepareAsync();
                    jcPlayerView.dismissProgressBar();
                }
                else {
                    jcPlayerView.showProgressBar();
                    new Parse(mContext).playMusic(mMediaPlayer, item, jcPlayerView);
                    String s = "";
                }
                jcPlayerView.showMediaInfo(item);
